...
- Provides liquidity for chain tokens
- Uses x\*y=k constant product formula
- 0.3% trading fee
- Allows users to buy/sell tokens without counterparties

### Stability Mechanism

- Base "Awesome!" token maintains 1:1 parity with AwesomeCoin
- Platform maintains peg through server reserves
- Specialized chain tokens fluctuate based on market activity
- Creates reliable foundation while allowing for growth through specialty chains

### Rewards

- Achievement acceptance: 50 tokens
- Block creation: 75 tokens
- Quality reviews: 10 tokens each
- AMM trading fees for liquidity providers
